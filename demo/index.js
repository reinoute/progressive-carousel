...
var fscreen = unwrapExports(index);
...
function Carousel(root) {
    ...
    function animate(direction) {
        ...
        items.forEach(function (item, index$$1) {
            // add event listener so that class can be removed after CSS transition has ended
            item.addEventListener(transitionEventName, onAnimateEnded(item, index$$1, direction));
    ...
    function onAnimateEnded(item, index$$1, direction) {
        var handleAnimateEnded = function () {
            ...
            var lastItem = index$$1 === items.length - 1;
    ...
    function updateTabindex() {
        ...
        anchors.forEach(function (anchor, index$$1) {
            ...
            } else if (index$$1 === focusableAnchorIndex) {
...
var enhanceAll = function () {
    var elements = [].slice.call(document.querySelectorAll('[data-carousel]'));
    return elements.map(function (element) { return new Carousel(element); });
};

var Carousel$1 = {enhanceAll: enhanceAll};

Carousel$1.enhanceAll();
